    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50 p-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-3xl font-bold text-orange-900">Kitchen Dashboard</h1>
              ...
              <div className="mt-6">
                ...
                <div className="grid gap-3">
                  {pendingOrders.map((order) => (
                    <Card key={order.id} className="border-orange-300 bg-orange-50">
                  ...
                  <div>
                    ...
                    <div className="flex gap-2 mt-1">
                      <Button
                        ...
                        className={orderType === "dine-in" ? "bg-blue-600 hover:bg-blue-700" : ""}
                      >
                        Dine-in
                      </Button>
                      <Button
                        ...
                        className={orderType === "takeaway" ? "bg-purple-600 hover:bg-purple-700" : ""}
                      >
                        Takeaway
                      </Button>
                    </div>
